...
"C:\Program Files\7-Zip\7z.exe" a -tzip %BUILD_DIR%\%PROJECTNAME%-win-standalone.zip %BUILD_DIR%\%PROJECTNAME%.exe %BUILD_DIR%\docs\ %BUILD_DIR%\ATRC\ %BUILD_DIR%\LICENSE %BUILD_DIR%\README.md
