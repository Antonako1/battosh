...
badd +231 Documents\GitHub\battosh\_source\tosh.cpp
badd +36 Documents\GitHub\battosh\_source\VARIABLES.cpp
badd +0 Documents\GitHub\battosh\_source\pathing.cpp
badd +0 Documents\GitHub\battosh\_source\VARIABLES.hxx
badd +7 Documents\GitHub\battosh\.gitignore
badd +69 Documents\GitHub\battosh\_source\battosh.hxx
argglobal
%argdel
set stal=2
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit Documents\GitHub\battosh\_source\
...
exe 'vert 4resize ' . ((&columns * 91 + 104) / 209)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists(fnamemodify("~\Documents\GitHub\battosh\_source\tosh.cpp", ":p")) | buffer ~\Documents\GitHub\battosh\_source\tosh.cpp | else | edit ~\Documents\GitHub\battosh\_source\tosh.cpp | endif
balt ~\Documents\GitHub\battosh\_source\battosh.hxx
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 65 - ((17 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 65
...
wincmd w
argglobal
if bufexists(fnamemodify("~\Documents\GitHub\battosh\_source\VARIABLES.cpp", ":p")) | buffer ~\Documents\GitHub\battosh\_source\VARIABLES.cpp | else | edit ~\Documents\GitHub\battosh\_source\VARIABLES.cpp | endif
balt ~\Documents\GitHub\battosh\_source\tosh.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
silent! normal! zE
let &fdl = &fdl
let s:l = 60 - ((5 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 60
...
wincmd w
argglobal
if bufexists(fnamemodify("~\Documents\GitHub\battosh\_source\pathing.cpp", ":p")) | buffer ~\Documents\GitHub\battosh\_source\pathing.cpp | else | edit ~\Documents\GitHub\battosh\_source\pathing.cpp | endif
balt ~\Documents\GitHub\battosh\_source\VARIABLES.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
exe 'vert 4resize ' . ((&columns * 91 + 104) / 209)
tabnext
edit ~\Documents\GitHub\battosh\_source\VARIABLES.hxx
argglobal
balt ~\Documents\GitHub\battosh\_source\pathing.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
